/**
 * Code here can be drastically optimized!!
 * The code was actually written years ago.
 * Round about the time snap svg just started
 * out. It was my first introduction in coding
 * anything animation related. 
 * 
 * Thus this is me writing very repetitive code
 * trying to understand more about the sequence
 * of events in animations.
 * 
 * I am however just refactoring the case 
 * standards and spacing as the younger me had
 * a clear disregard for ensuring code is 
 * readable. :-(  
 */
